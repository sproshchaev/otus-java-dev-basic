 ...
 * inc() и dec() будем увеличивать и уменьшать значения полей. Создадим критические секции в самом методе и объявим два
 * монитора на объектах Object
 *
 * Консоль:
 * Thread-0 start
 * Thread-1 start
 ...
 *
 * 2) Если убрать критические секции из методов, то код будет работать не верно
 * public void inc1() {
 *   // synchronized (mon1) {
 *         c1++;
 *   // }
