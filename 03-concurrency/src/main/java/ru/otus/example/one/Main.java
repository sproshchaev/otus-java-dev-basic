...
public class Main {
    ...
    public static void main(String[] args) {
         ...
         * Пример 3:
         * ---------
         * Если два потока у одного и того же объекта main1 вызывают разные синхронизированные методы .method2() и .method1(), то такое выполнение будет ТОЖЕ последовательным. Сначала один поток отработал. Затем второй.
         ...
         * Эти методы будут выполняться параллельно, так как Мониторы здесь разные.
         *
         * Консоль:
