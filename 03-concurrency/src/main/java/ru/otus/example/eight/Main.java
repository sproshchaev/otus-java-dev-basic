 ...
 *
 * #Демо8.1
 * Класс Box, у которого создано методы:
 ...
 *
 * У нас в выполнении методов в разных потоках будет присутствовать большое число запросов на выполнение этих методов,
 * которые можно сократить, если вызывать в момент освобождения монитора (см. Main2.java).
 */
public class Main {
