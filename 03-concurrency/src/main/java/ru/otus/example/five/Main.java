 ...
 * (Пишем код этого класса и сначала запускаем каждый экз.класса по отдельности - они будут отрабатывать без проблем - показываем это в консоли.
 * А затем запускаем оба потока - и видим Deadlock в консоли)
 *
 * Консоль:
 * Thread-1 Started
 * Thread-0 Started
 ...
 *
 * И мы видим, что потоки перешли во взаимную блокировку и не могут выйти из этой ситуации.
 *
...
public class Main {
    ...
    // Второй статический внутренний класс
